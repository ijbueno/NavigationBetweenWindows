...
class TerceiroFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        view.findViewById<Button>(R.id.cmd5).setOnClickListener { Navigation.findNavController(view).navigate(R.id.navegarTerceiroParaPrimeiro) }
        view.findViewById<Button>(R.id.cmd6).setOnClickListener { Navigation.findNavController(view).navigate(R.id.navegarTerceiroParaSegundo) }
