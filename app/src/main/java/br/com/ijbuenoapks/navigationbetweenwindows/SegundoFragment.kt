...
class SegundoFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        view.findViewById<Button>(R.id.cmd3).setOnClickListener { Navigation.findNavController(view).navigate(R.id.navegarSegundoParaPrimeiro) }
        view.findViewById<Button>(R.id.cmd4).setOnClickListener { Navigation.findNavController(view).navigate(R.id.navegarSegundoParaTerceiro) }
